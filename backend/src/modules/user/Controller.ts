...
class UserController {
  ...
  getByEmail = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      new SystemResponse(res, 'error retrieving user by email!', error).internalServerError();
    }
  };
  ...
  getAll = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      new SystemResponse(res, 'error retrieving all users!', error).internalServerError();
    }
  };
  ...
  register = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const existingUser: IUser | null = await this.userService.getByEmail(newUser.email);
      ...
      new SystemResponse(res, 'error creating new user!', error.message).internalServerError();
    }
  };
  ...
  login = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      new SystemResponse(res, 'error logging existing user!', error.message).internalServerError();
    }
  };
  ...
  getByToken = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      new SystemResponse(res, 'error retrieving user by token!', error).internalServerError();
    }
  };
  ...
  getById = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      new SystemResponse(res, 'Error retrieving user by userId.', error).internalServerError();
    }
  };
  ...
  updateById = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      new SystemResponse(res, 'error updating user!', error).internalServerError();
    }
  };
  ...
  deleteById = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      new SystemResponse(res, 'Error deleting user by id!', error).internalServerError();
    }
  };
}
