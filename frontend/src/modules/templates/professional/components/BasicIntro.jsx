...
export default function BasicIntro({ basics }) {
  return (
    <div className="flex justify-between">
      ...
      <div className="flex flex-col justify-end items-end gap-2">
        <div className="flex gap-2">
          <img src={'/icons/phone.svg'} alt="Phone" width={12} height={12} />
        ...
        <div className="flex gap-2">
          <img src={'/icons/mail.svg'} alt="Email" width={12} height={12} />
        ...
        {basics.location.city && (
          <div className="flex gap-2">
            <img src={'/icons/location.svg'} alt="Location" width={12} height={12} />
